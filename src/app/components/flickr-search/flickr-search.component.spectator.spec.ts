...
describe('FlickrSearchComponent with spectator', () => {
  ...
  /*
  Nous remplaçons les composants enfants par des faux créés par ng-mocks.
  Les faux composants imitent les originaux en ce qui concerne leurs entrées et sorties, mais ils ne rendent rien.
  Nous allons travailler avec ces instances de composants au lieu d'opérer sur les DebugElements.
  */
